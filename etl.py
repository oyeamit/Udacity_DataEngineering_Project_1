...
def process_song_file(cur, filepath):
    '''
    Reads a song file and stores the data into songs and artists tables.

            Parameters:
                    cur (cursor): psycopg2 cursor connection to postgres
                    filepath (string): song file path on disk
...
def process_log_file(cur, filepath):
    '''
    Reads a log file and stores the data into time, users and songplays tables.
...
def process_data(cur, conn, filepath, func):
    '''
    Reads dataset and stores into database.

            Parameters:
                    cur (cursor): psycopg2 cursor connection to postgres
                    conn: psycopg2 connection object
                    filepath (string): song file path on disk
                    func (function): function to be executed (either process_song_file or process_log_file)
    '''
